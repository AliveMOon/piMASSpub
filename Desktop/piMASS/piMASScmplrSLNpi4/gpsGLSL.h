...
"					floor( vec2( fract(ac.y)*crl.z, ac.y ) ) + (1.0/3.0) );		// LUT		\n"
"	o /= vec4( crl.xy, lwh ); 													\n"
"	o.w += floor(rgba.g/0x80); 				// GREEN	// chr.z			\n"
"	return o;																				\n"
"}																							\n"
"void main() {																				\n"
...
"			off2x3 = 1.0/aTX[2];							// aTX[3] == mn_iso_CR			\n"
"																							\n"
//"	gl_FragColor = texture2D( gpdTXmin, fr_uv );			\n"
//"	return;													\n"
...
"			if( A.r > 0 ) {																	\n"
"				cl = cr_lut( A, gpdTXcrl, gpdTXwh );										\n"
"				A = texture2D( gpdTXmin, cl.xy+Ain+t2x3*vec2( 0, 0 )-gpdTXiz )				\n"
"				*texture2D( gpdTXmin, cl.zw );												\n"
"			} else 																			\n"
"				A = m0p13.yyyy; 															\n"
"			if( B.r > 0 ) {																	\n"
"				cl = cr_lut( B, gpdTXcrl, gpdTXwh );										\n"
"				B = texture2D( gpdTXmin, cl.xy+Ain+t2x3*vec2( 1, 0 )-gpdTXiz )				\n"
"				*texture2D( gpdTXmin, cl.zw );												\n"
"			} else 																			\n"
"				B = m0p13.yyyy; 															\n"
"																							\n"
...
"				C = texture2D( gpdTXmin, cl.xy+Ain+t2x3*vec2( 0, 1 )-gpdTXiz )				\n"
"				*texture2D( gpdTXmin, cl.zw );												\n"
"			} else																			\n"
"				C = m0p13.yyyy;																\n"
"																							\n"
...
"				D = texture2D( gpdTXmin, cl.xy+Ain+t2x3*vec2( 1, 1 )-gpdTXiz )				\n"
"				*texture2D( gpdTXmin, cl.zw );												\n"
"			} else 																			\n"
"				D = m0p13.yyyy; 															\n"
"																							\n"
...
"				F = texture2D( gpdTXmin, cl.xy+Ain+t2x3*vec2( 1, 2 )-gpdTXiz )				\n"
"				*texture2D( gpdTXmin, cl.zw );												\n"
"			} else																			\n"
"				F = m0p13.yyyy; 															\n"
"																							\n"
