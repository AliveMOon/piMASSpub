...
"{																												\n"
"	vec2 ac = ( rgba.rg + vec2(rgba.b,0.0) ) / crl.xz;															\n"
"	return vec4( 																								\n"
"					floor( vec2(fract(ac.x)*crl.x,ac.x) ),											// char		\n"
"					floor( vec2(fract(ac.y)*crl.z,ac.y) )  // + floor(vec2(0.0, ac.y*lwh.y/crl.z))	// LUT		\n"
"				) / vec4( crl.xy, lwh );																		\n"
"}																												\n"
"																												\n"
"void main()																									\n"
...
"																										\n"
"	// F --------------------------------------------------------										\n"
"	vec4 	A = texture2D( gpdTXut, frm0 + off0 + off2x3*vec2( -1, 2 ) ) 								\n"
"							* vec4( 0x100,0x100,0x10000,0x100 ),										\n"
...
"																										\n"
"	// E --------------------------------------------------------										\n"
"	A = texture2D( gpdTXut, frm0 + off0 + off2x3*vec2( 0, 2 ) ) 										\n"
"					* vec4( 0x100,0x100,0x10000,0x100 );												\n"
"	if( A.r > 0 )																						\n"
"	{																									\n"
"		cl	= cr_lut( A, gpdTXcrl, gpdTXwh );															\n"
...
"	}																									\n"
"	// D --------------------------------------------------------										\n"
"	A = texture2D( gpdTXut, frm0 + off0 + off2x3*vec2(-1, 1 ) ) 										\n"
"					* vec4( 0x100,0x100,0x10000,0x100 );												\n"
"	if( A.r > 0 )																						\n"
"	{																									\n"
"		cl	= cr_lut( A, gpdTXcrl, gpdTXwh );															\n"
...
"																										\n"
"	// C --------------------------------------------------------										\n"
"	A = texture2D( gpdTXut, frm0 + off0 + off2x3*vec2( 0, 1 ) ) 										\n"
"					* vec4( 0x100,0x100,0x10000,0x100 );												\n"
"	if( A.r > 0 )																						\n"
"	{																									\n"
"		cl	= cr_lut( A, gpdTXcrl, gpdTXwh );															\n"
...
"	}																									\n"
"	// B --------------------------------------------------------										\n"
"	A = texture2D( gpdTXut, frm0 + off0 + off2x3*vec2( -1, 0 ) ) 										\n"
"					* vec4( 0x100,0x100,0x10000,0x100 );												\n"
"	if( A.r > 0 )																						\n"
"	{																									\n"
"		cl	= cr_lut( A, gpdTXcrl, gpdTXwh );															\n"
